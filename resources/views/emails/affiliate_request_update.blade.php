                                ...
                                <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 10px; padding-left: 10px;">
                                    ...
                                    <div style="color:#555555;font-family:TimesNewRoman, 'Times New Roman', Times, Baskerville, Georgia, serif;line-height:120%;padding-top:15px;padding-right:0px;padding-bottom:15px;padding-left:0px;">
                                        <div style="font-family: TimesNewRoman, 'Times New Roman', Times, Baskerville, Georgia, serif; font-size: 12px; line-height: 14px; color: #555555;">
                                            <p style="font-size: 12px; line-height: 14px; margin: 0; {{app()->getLocale() == 'ar'? "text-align: left ;direction:ltr" : "text-align: right"}}">{{date("Y-m-d h:i a")}}</p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
                                    <!--[if (!mso)&(!IE)]><!-->
                                ...
                                <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
                                    ...
                                    <div style="color:#71777D;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;line-height:150%;padding-top:25px;padding-right:10px;padding-bottom:15px;padding-left:10px;">
                                        <div style="font-size: 12px; line-height: 18px; font-family: 'Lato', Tahoma, Verdana, Segoe, sans-serif; color: #71777D;">
                                            <p style="font-size: 14px; line-height: 21px; margin: 0;{{app()->getLocale() == 'ar'? "text-align: right ;direction:ltr" : "text-align: left"}}">
                                                <span style="color: #000000; font-size: 14px; line-height: 21px;"><strong>{{trans('email.Hi')}} {{$affiliateRequest->name}},</strong></span>
                                            </p>
                                            <p style="font-size: 14px; line-height: 21px; margin: 0; {{app()->getLocale() == 'ar'? "text-align: right ;direction:ltr" : "text-align: left"}}"></p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
                                ...
                                <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
                                    ...
                                    <div style="color:#000000;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;line-height:120%;padding-top:10px;padding-right:10px;padding-bottom:30px;padding-left:10px;">
                                        <div style="font-size: 12px; line-height: 14px; font-family: 'Lato', Tahoma, Verdana, Segoe, sans-serif; color: #000000;">
                                            @if($affiliateRequest->status == 1)
                                                <p style="font-size: 14px; line-height: 16px; text-align: center; margin: 0;">
                                                    <strong><span
                                                                style="font-size: 18px; line-height: 21px;">{{trans('email.affiliateRequestApprovedMessage')}} </span></strong><strong><span
                                                                style="font-size: 18px; line-height: 21px;"></span></strong>
                                                </p>
                                            @elseif($affiliateRequest->status == 2)
                                                <p style="font-size: 14px; line-height: 16px; text-align: center; margin: 0;">
                                                    <strong><span style="font-size: 18px; line-height: 21px;">{{trans('email.affiliateRequestRejectMessage')  }} <br> {{$affiliateRequest->rejection_reason}} </span></strong><strong><span
                                                                style="font-size: 18px; line-height: 21px;"></span></strong>
                                                </p>
                                            @endif
                                        </div>
                                    ...
                                    @if($affiliateRequest->status == 1)
                                        <div align="center" class="button-container"
                                            ...
                                            <tr>
                                                <td style="padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px"
                                                    ...
                                                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                                                 ...
                                                                 href="https://dev.soleekhub.com/eweb/account/order-history/233"
                                            ...
                                            <![endif]--><a href='{!!config('app.website_url') . "/session/signin" !!}'
													...
													<span style="font-size: 16px; line-height: 32px;">{{trans('email.loginNow')}}</span>
												</span></a>
                                    ...
                                    <div style="color:#555555;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;line-height:120%;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
                                        <div style="font-size: 12px; line-height: 14px; font-family: 'Lato', Tahoma, Verdana, Segoe, sans-serif; color: #555555;">
                                            <p style="font-size: 14px; line-height: 14px; margin: 0;"><span
                                                        style="font-size: 12px;">{{trans('email.copyright')}} </span>
                                            </p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
