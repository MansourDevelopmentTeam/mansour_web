...
', $encoding = 'UTF-8', $bom = false)
     ...
     */ 
        ...
        {
                        /** @var \App\Classes\Sms\SmsEg $instance */
                        return $instance->send($phone);
        }
                    /**
         * Verify customer phone number
         *
         * @param \App\Classes\Sms\[type] $phone
         * @param \App\Classes\Sms\[type] $address_id
         * @param \App\Classes\Sms\[type] $otp
         * @return boolean 
         * @static 
         */ 
        ...
        {
                        /** @var \App\Classes\Sms\SmsEg $instance */
                        return $instance->verify($phone, $otp);
        }
                    /**
         * Get balance
         *
        ...
        {
                        /** @var \App\Classes\Sms\SmsEg $instance */
                        $instance->sendSms($phone, $message);
        }
                    /**
         * Verify otp for user
         *
...
namespace  { 
            ...
            class Sms extends \App\Facade\Sms {}
            class Flare extends \Facade\Ignition\Facades\Flare {}
            class Image extends \Intervention\Image\Facades\Image {}
            class Socialite extends \Laravel\Socialite\Facades\Socialite {}
            class Excel extends \Maatwebsite\Excel\Facades\Excel {}
            class Aramex extends \Octw\Aramex\Aramex {}
